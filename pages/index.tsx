...
const Home = (props: Props & { hasMore: boolean }) => {
  return (
    <div>
      ...
      <p>I am Ryosuke Suzuki, a software engineer in Tokyo, preferring to work at a startup, enjoying singing, born in 1996, finished a degree of mathematics in Meiji university.</p>
